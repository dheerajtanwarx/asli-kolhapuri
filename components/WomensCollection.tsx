  ...
  return (
    ...
    >
      <div className="container-kw">
        ...
        {/* Products Grid + Collection Image (Reversed layout from Men's) */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "40px", alignItems: "stretch" }}>
          ...
          >
            ...
            >
              ...
              >
                Adorned with intricate beadwork and embroidery, each pair is a
                masterpiece of Rajasthani artistry.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <style jsx global>{`
        @media (max-width: 900px) {
          #womens-collection .container-kw > div:last-child {
